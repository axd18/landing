      ...
      <div className="order-2 w-full max-w-2xl flex-1 py-8 lg:order-1 lg:py-0 lg:pr-8">
        ...
        <form onSubmit={handleSubmit} className="mt-8">
          ...
          <div className="mt-4 flex flex-col space-y-3 sm:flex-row sm:space-y-0 sm:space-x-3">
            ...
            <button 
              type="submit"
              className="rounded-lg bg-blue-600 px-6 py-3 text-base font-medium text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:px-8"
            >
              Recibí la demo
            </button>
          </div>
