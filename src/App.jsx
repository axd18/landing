...
import flowbiteImage from '../src/assets/flowbite.jpg'
// import './App.css'
    ...
    <main className="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-slate-200 ">
      <div className="flex justify-between px-4 mx-auto max-w-screen-xl">
        <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
          ...
          <h2 className="text-2xl font-bold dark:text-white mt-6 mb-4">
          ...
          <h3 className="text-xl font-bold dark:text-white mt-6 mb-4">
          ...
          <h4 className="text-lg font-bold dark:text-white mt-4 mb-2">
            Type properties
          </h4>
          <p>
